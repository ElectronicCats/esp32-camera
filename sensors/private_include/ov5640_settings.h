...
const DRAM_ATTR uint16_t default_regs[][2] = {
	{ CLOCK_POL_CONTROL, 0x21 },//polarity

	{ 0x4050, 0x6e },
	{ 0x4051, 0x8f },

	{ SCCB_SYS_CTRL1, 0x03 },//PLL
	{ PAD_OUTPUT_ENABLE01, 0x7f },//output enable
	{ PAD_OUTPUT_ENABLE02, 0xff },//output enable
	{ 0x302c, 0x02 },//frex enable
	{ SYS_ROOT_DIVIDER, 0x01 },//pad clock divider
	{ 0x3630, 0x2e },//2e
	{ 0x3632, 0xe2 },
	{ 0x3633, 0x23 },//23
	{ 0x3621, 0xe0 },
...
const DRAM_ATTR uint16_t OV5640_AF_REG[][2] = {
	{0x3000,0x20},
	{0x8000,0x02},
	{0x8001,0x0f},
	{0x8002,0xd6},
